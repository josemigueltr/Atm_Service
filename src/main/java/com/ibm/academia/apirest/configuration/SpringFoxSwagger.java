...
public class SpringFoxSwagger {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Bank-ServicesAPI",
                "Servicio para poder obtener sucursales y ATM(Cajeros automaticos)cercanos a la ubicacion de un cliente",
                "v1",
                "Términos del servicio",
                new Contact("Jose Miguel Toledo Reyes", "https://github.com/josemigueltr", "josemigueltr@ibm.com"),
